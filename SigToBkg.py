...
class SignalSignificance(PlotterBase):
...
if __name__ == "__main__":
    ...
    channel = "3mu"
    h_sigs = {}
    for name in signal_points_MHc130:
        file = TFile(
    ...
    file_bkg = TFile(SKFlat_output + "background/SigToBkg_background.root")
    h_bkg = file_bkg.Get("cutflow/" + channel)

    plotter = SignalSignificance(cvs_params, hist_params, info_params)
